...
// const { baseURL, javaHost, isMock, mockServer } = Config;
...
// // 提供两种实例
// let instanceForNode = axios.create(createOpt(baseURL));
// let instanceForJava = axios.create(createOpt(isMock ? mockServer : javaHost));
// [instanceForJava, instanceForNode].forEach(ele => {
...
// export default instanceForNode;
// export const axiosForJava = instanceForJava;
